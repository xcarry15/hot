...
- 设置：数据源、关键词、AI、评分、推送目标、自动抓取、数据维护和提示词；概览按“抓取记录 / 推送记录”和“公开浏览 / 每日文章动态”两行排列，提供公开浏览量 Top 20 文章并展示文章发布时间和评分，点击可直接跳转工作台打开文章详情，同时按日展示新增、公开和推送数量。概览时间范围会同步应用于所有统计卡片、抓取记录、推送记录和图表。
