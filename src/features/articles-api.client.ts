...
export async function updateArticleEditorial(
  articleId: string,
  input: { summary?: string; brand?: string; category?: string; eventIdentity?: { subjects: string[]; action: string; object: string }; keyPoints?: string[]; publicOverride?: 'auto' | 'public' | 'hidden'; relevance?: number; eventScore?: number; contentScore?: number; adProbability?: number; isAd?: boolean; restoreFields?: ManualOverrideField[]; expectedUpdatedAt?: string },
