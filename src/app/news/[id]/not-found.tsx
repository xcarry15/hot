    ...
    <div className="public-site flex min-h-[100dvh] flex-col bg-background text-foreground">
      ...
      <main className="mx-auto flex w-full max-w-[1200px] flex-1 items-center justify-center px-4 py-16 sm:px-6">
        <section className="w-full max-w-md rounded-xl border border-[var(--public-hairline)] bg-[var(--public-surface)] px-6 py-14 text-center">
          ...
          <Link href="/" className="mt-6 inline-flex h-10 items-center rounded-md bg-[var(--public-primary)] px-4 text-sm font-medium text-white transition-colors hover:bg-[var(--public-primary-active)] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[color:rgb(204_120_92_/_0.25)]">返回文章列表</Link>
        </section>
      </main>
      <PublicFooter />
    </div>
